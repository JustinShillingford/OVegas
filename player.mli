...
type player = {id: string; two_cards: hand; money: int; latest_command: string option;
              remaining_in_round:bool; money_in_pot:int; is_human:bool}

(* [init_player name deck] is a new player (not an AI) and the remaining deck
 * after dealing that player's hand. *)
