...
type state = {players: Player.player list; round: int; street: int; pot:int; shared_cards: Card.card list; latest_bet:int}
...
val initial_state : Player.player list -> Table.deck -> state * Table.deck
