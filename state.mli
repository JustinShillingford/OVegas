...
(* [state] is a combination of players, a table, a counter keeping track of(* [state] is a combination of players, a table, a counter keeping track of
 ...
 * turns and rounds of the game. *)
type state = {players: Player.player list; play_round: int; bet_round: int; pot:int; table: Table.table; latest_bet:int; curr_player: Player.player; message: string; first_action: bool; latest_st_command: string option}
